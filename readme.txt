...
Donate link: https://www.tooltipy.com
Tags: report comments, flagging
...
1. Upload the folder to your site's wp-content/plugins directory
1. Activate the plugin in the WordPress Admin Panel
1. Click on settings to manage the options

== Screenshots ==
1. Main settings page (under comments)
2. Custom E-Mail template using lots of shortcodes (modifiers)
3. Use the flag to report a comment to send it directly to the moderator E-Mail
4. Example of E-Mail received from the moderator side
